 ...
 */
public class BasicGyro extends GyroBase implements Gyro, PIDSource { //removed livewindow sendable
     ...
     */
    public BasicGyro(SPI.Port port) {
        m_spi = new SPI(port);
    ...
    private int readRegister(int reg) {
        ...
        int printMe = (buf.getInt(0) >> 5) & 0xffff;

        System.out.println(printMe);

        return printMe; //        return (buf.getInt(0) >> 5) & 0xffff;
