...
public class OI {
  ...
  JoystickButton js1_ElevatorUp = new JoystickButton(driverStick, 5);
  JoystickButton js1_ElevatorDown = new JoystickButton(driverStick, 6);

  //Arm
  JoystickButton js1_ArmUp = new JoystickButton(driverStick, 7);
  JoystickButton js1_ArmDown = new JoystickButton(driverStick, 8);
  ...
  public OI() {
    ...
    //js1_GrabIntake.whenPressed(gi);
    js1_ShootIntake.whenPressed(shootI);
    js1_StopIntake.whenPressed(si);


    js1_ElevatorStop.whenPressed(es);
    js1_ElevatorUp.whenPressed(eu);
